...
class Obstacle () {
    class Obstaclec(var x1: Float, var y1: Float, var rayonO1: Float, var view : CurlingView) {
    ...
    class Obstacler(var x1: Float, var y1: Float, var rayonO2: Float, var view : CurlingView) {
